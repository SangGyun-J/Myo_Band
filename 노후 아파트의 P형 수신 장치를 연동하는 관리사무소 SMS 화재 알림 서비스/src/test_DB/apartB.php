...
$sql = "INSERT INTO `apart_alarm`(`apart_name`, `manager_name`, `phone_num`, `position`) VALUES('$apart_name','$mananger_name','$phone_num','$position')";
$sql2 = "INSERT INTO `apart_alarm`(`apart_name`, `manager_name`, `phone_num`, `position`) VALUES('$apart_name2','$mananger_name2','$phone_num2','$position2')";
